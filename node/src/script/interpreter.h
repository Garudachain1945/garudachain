...
enum : uint32_t {
    ...
    // GarudaChain: Enable ML-DSA-87 post-quantum witness v2 verification
    //
    SCRIPT_VERIFY_QUANTUM = (1U << 21),
...
enum class SigVersion
{
    ...
    QUANTUM = 4,     //!< Witness v2 with 32-byte program (SHA256 of ML-DSA-87 pubkey); GarudaChain P2PQH
};
...
public:
    ...
    virtual bool CheckQuantumSignature(Span<const unsigned char> sig, Span<const unsigned char> pubkey, const CScript& scriptCode, ScriptError* serror = nullptr) const
    {
        return false;
    }
...
public:
    ...
    bool CheckQuantumSignature(Span<const unsigned char> sig, Span<const unsigned char> pubkey, const CScript& scriptCode, ScriptError* serror = nullptr) const override;
...
public:
    ...
    bool CheckQuantumSignature(Span<const unsigned char> sig, Span<const unsigned char> pubkey, const CScript& scriptCode, ScriptError* serror = nullptr) const override
    {
        return m_checker.CheckQuantumSignature(sig, pubkey, scriptCode, serror);
    }
