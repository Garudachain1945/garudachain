...
// GarudaChain: SCRIPT_VERIFY_QUANTUM included so signet block validation
// enforces ML-DSA-87 for any P2PQH outputs in the signet challenge script.
static constexpr unsigned int BLOCK_SCRIPT_VERIFY_FLAGS = SCRIPT_VERIFY_P2SH | SCRIPT_VERIFY_WITNESS | SCRIPT_VERIFY_DERSIG | SCRIPT_VERIFY_NULLDUMMY | SCRIPT_VERIFY_QUANTUM;
