...
private:
    ...
    MintBurnPage    *mintBurnPage{nullptr};
    CreateTokenPage *createTokenPage{nullptr};
    InvestPage      *investPage{nullptr};
...
public Q_SLOTS:
    ...
    /** Switch to mint/burn (stablecoin) page */
    void gotoMintBurnPage();
    /** Switch to create token (saham) page */
    void gotoCreateTokenPage();
    /** Switch to invest (e-IPO, portofolio, swap) page */
    void gotoInvestPage();
