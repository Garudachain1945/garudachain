...
{
    switch (unit) {
    case Unit::BTC: return QString("GRD");
    case Unit::mBTC: return QString("mGRD");
    case Unit::uBTC: return QString::fromUtf8("µGRD (bits)");
    case Unit::SAT: return QString("Receh (rch)");
...
QString BitcoinUnits::shortName(Unit unit)
{
    ...
    case Unit::uBTC: return QString::fromUtf8("µGRD");
    case Unit::SAT: return QString("rch");
    } // no default case, so the compiler can warn about missing cases
    assert(false);
}
...
{
    switch (unit) {
    case Unit::BTC: return QString("Garuda");
    case Unit::mBTC: return QString("Milli-Garuda (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Garuda (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    case Unit::SAT: return QString("Receh (rch) (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    } // no default case, so the compiler can warn about missing cases
    assert(false);
}
