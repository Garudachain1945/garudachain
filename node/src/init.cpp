...
void Shutdown(NodeContext& node)
{
    ...
    // GarudaChain: shutdown AssetDB & DexDB
    Assets::ShutdownAssetDB();
    DEX::ShutdownDexDB();
...
void SetupServerArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-walletmode=<mode>", "GarudaChain node operating mode: cbdc, creator, public, normal (default: normal)", ArgsManager::ALLOW_ANY | ArgsManager::NETWORK_ONLY, OptionsCategory::OPTIONS);
    argsman.AddArg("-cbdcauthoritypubkey=<hex>", "CBDC authority Schnorr pubkey (32-byte x-only, hex)", ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
    argsman.AddArg("-cbdcpqcpubkeyhash=<hex>", "CBDC authority ML-DSA-87 pubkey hash (SHA256, hex). Set to enable PQC hybrid.", ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
    argsman.AddArg("-cbdcapbnhash=<hex>", "APBN treasury script hash (20 or 32 byte hex)", ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
    argsman.AddArg("-cbdcmintfeeppm=<n>", "CBDC mint fee in PPM (1000=0.1%, default: 1000)", ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
    argsman.AddArg("-cbdctreasurymultisig=<m-of-n>", "Treasury multi-sig config (default: 2-of-3)", ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
    argsman.AddArg("-cbdctreasurytimelock=<blocks>", "Treasury CSV timelock in blocks (default: 144)", ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
...
bool AppInitParameterInteraction(const ArgsManager& args)
{
    ...
    // GarudaChain: set wallet/node operating mode (cbdc | creator | public | normal)
    CBDC::SetWalletMode(args.GetArg("-walletmode", "normal"));
    LogPrintf("GarudaChain walletmode: %s\n", args.GetArg("-walletmode", "normal"));

    // GarudaChain: initialize authority keys from config
    CBDC::InitAuthorityKeys();
    CBDC::InitTreasuryConfig();

    // GarudaChain: initialize AssetDB & DexDB
    Assets::InitAssetDB(args.GetDataDirNet());
    DEX::InitDexDB(args.GetDataDirNet());
