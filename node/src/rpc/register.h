...
void RegisterCBDCRPCCommands(CRPCTable&);
void RegisterAssetRPCCommands(CRPCTable&);
void RegisterDexRPCCommands(CRPCTable&);
void RegisterPQCRPCCommands(CRPCTable&);
