...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "placeorder", 2, "amount" },
    { "placeorder", 3, "price" },
    { "setupmarketmaker", 2, "base_price" },
    { "setupmarketmaker", 3, "spread_bps" },
    { "setupmarketmaker", 4, "order_size" },
    { "setupmarketmaker", 5, "num_levels" },
    { "refreshmarketmaker", 1, "new_base_price" },
    { "swapgrdtostable", 2, "grd_amount" },
    { "swapstabletogrd", 2, "stablecoin_amount" },
    { "matchorders", 0, "asset_id" },
    { "issueasset", 3, "total_supply" },
    { "issueasset", 5, "face_value" },
    { "issueasset", 6, "maturity" },
    { "issueasset", 7, "coupon" },
    { "issueasset", 8, "nav" },
    { "issueasset", 9, "peg_rate" },
    { "mintasset", 1, "amount" },
    { "burnasset", 1, "amount" },
    { "transferasset", 1, "amount" },
    { "declaredividend", 1, "total_dividend" },
    { "swapasset", 2, "from_amount" },
    { "swapstable", 2, "from_amount" },
    { "swapforextopeg", 2, "amount" },
    { "updatepegrate", 1, "grd_per_unit" },
    { "syncpegrates", 0, "grd_price_usd" },
    { "startpegratesync", 0, "interval_seconds" },
    { "startpegratesync", 1, "grd_price_usd" },
    // CBDC / stablecoin / ledger admin
    { "mintgaruda", 0, "amount" },
    { "burngaruda", 1, "vout" },
    { "burngaruda", 3, "amount" },
    { "depositgrd", 1, "amount" },
    { "withdrawgrd", 1, "amount" },
    { "issuepegged", 1, "total_supply" },
};
// clang-format on
