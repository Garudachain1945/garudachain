    ...
    return
         {
             ...
             {RPCResult::Type::STR, "address", /*optional=*/true, "The GarudaChain address (only if a well-defined address exists)"},
...
static RPCHelpMan decodepsbt()
{
    return RPCHelpMan{
        "decodepsbt",
        "Return a JSON object representing the serialized, base64-encoded partially signed GarudaChain transaction.",
                {
...
static RPCHelpMan combinepsbt()
{
    return RPCHelpMan{"combinepsbt",
                "\nCombine multiple partially signed GarudaChain transactions into one transaction.\n"
